...
def train_on_original_graph():
    ...
    for j in range(args.teacher_model_loop+1):
        ...
        if j % args.teacher_model_loop == 0:
            ...
            if(acc_val>best_val):
                ...
                best_test=acc_test
                if args.save:
                    torch.save(model.state_dict(), f'{root}/saved_model_large/teacher/{args.dataset}_{args.model}_{args.reduction_rate}_{args.nlayers}_{args.hidden}_{args.dropout}_{args.activation}_{args.seed}.pt')
